...
| `4`  | indeterminate | A question goetia could not answer about an id: its state, whether it is occupied at all, or the outcome of a request goetia did not wait out — it stopped waiting, or never waited — or whether a request reached the manager at all, when the tool carrying it had started and was lost. | The LSB init-script convention's "service status unknown".                                                |
